                        ...
                        [
                            {
                                ...
                                desc: "Viewer and Editor", link: "../Samples/II_View-Edit-Documents/Viewer-and-Editor.html", className: Enum_Demos.navigation, screenshotLink: ""
                            },
                            {
                        ...
                        [
							{
                                ...
                                desc: "HTTP Upload", link: "../Samples/III_Save-Upload-Documents/Save-Documents-to-HTTP-Server/Visual-Studio-Demo/Upload-to-HTTP-Server.html", className: Enum_Demos.httpupload, screenshotLink: "res/Images/UploadWithHTTP.png"
                            },
                            {
                        ...
                        [
							{
                                ...
                                desc: "Download from HTTP Server", link: "../Samples/IV_Load-Download-Documents/Download-from-HTTP-Server/Visual-Studio-Demo/Download-from-HTTP-Server.html", className: Enum_Demos.httpdownload, screenshotLink: "res/Images/DownloadWithHTTP.png"
                            }, 
                            {
                        ...
                        [
                            {
                                ...
                                API: [
                                    {
                                        name: "Addon.PDF.SetResolution()", APILink: "https://www.dynamsoft.com/web-twain/docs/info/api/Addon_PDF.html?ver=latest#setresolution"
                                    },
                                    {
                                        name: "Addon.PDF.SetConvertMode()", APILink: "https://www.dynamsoft.com/web-twain/docs/info/api/Addon_PDF.html?ver=latest#setconvertmode"
                                    },
                                    {
    ...
    for (var i = 0; i < aryDemo.categories.length; i++) {
        for (var j = 0; j < aryDemo.categories[i].demos.length; j++) {
            if (aryDemo.categories[i].demos[j].className == currentDemo) {
                ...
                if (currentDemo == Enum_Demos.sendextrainfo){ //(currentDemo == Enum_Demos.scanbarcode || currentDemo == Enum_Demos.scanwebcam) {
					...
					if(currentDemo == Enum_Demos.customscan){
						 $("#frmDemo").css({
                ...
                if (currentDemo == Enum_Demos.serversideocr || currentDemo == Enum_Demos.mobilecamera) {
                    $('.description').hide();
                } else {
                    $('.description').show();
                }
